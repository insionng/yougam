...
import (
	...
	"github.com/insionng/yougam/libraries/lib/pq/oid"
)
...
type parameterStatus struct {
	...
	// the current location based on the TimeZone value of the self.Session. if
	// available
...
func (c *conn) handlePgpass(o values) {
	...
	db := o.Get("dbname")
	username := o.Get("user")
	// From: https://yougam/libraries/tg/pgpass/blob/master/reader.go
