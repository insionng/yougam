...
//
// NOTE: Under construction. See https://yougam/libraries/design/text/12750-localization
// and its corresponding proposal issue https://yougam/libraries/issues/12750.
package message // import "github.com/insionng/yougam/libraries/x/text/message"
...
import (
	...
	"github.com/insionng/yougam/libraries/x/text/internal/format"
...
// state implements "github.com/insionng/yougam/libraries/x/text/internal/format".State.
type state struct {
	fmt.State
	p *Printer
}
