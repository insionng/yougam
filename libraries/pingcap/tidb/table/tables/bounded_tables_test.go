...
import (
	...
	"github.com/insionng/yougam/libraries/pingcap/tidb/column"
	"github.com/insionng/yougam/libraries/pingcap/tidb/context"
	"github.com/insionng/yougam/libraries/pingcap/tidb/kv"
	"github.com/insionng/yougam/libraries/pingcap/tidb/meta/autoid"
	...
	"github.com/insionng/yougam/libraries/pingcap/tidb/store/localstore/goleveldb"
	"github.com/insionng/yougam/libraries/pingcap/tidb/table"
	"github.com/insionng/yougam/libraries/pingcap/tidb/table/tables"
...
var _ = Suite(&testBoundedTableSuite{})

type testBoundedTableSuite struct {
	store kv.Storage
	se    tidb.Session
	tbl   table.Table
}

func (ts *testBoundedTableSuite) SetUpSuite(c *C) {
