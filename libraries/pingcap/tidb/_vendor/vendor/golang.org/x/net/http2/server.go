...
func (sc *serverConn) newWriterAndRequest(st *stream, f *MetaHeadersFrame) (*responseWriter, *http.Request, error) {
	...
	if bodyOpen {
		// Disabled, per yougam/libraries/issue/14960:
...
// is preferred:
//    https://yougam/libraries/pkg/net/http/#ResponseWriter
//    https://yougam/libraries/pkg/net/http/#example_ResponseWriter_trailers
