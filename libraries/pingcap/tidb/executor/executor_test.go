...
import (
	...
	"github.com/insionng/yougam/libraries/pingcap/tidb/store/tikv"
...
// For https://yougam/libraries/pingcap/tidb/issues/345
...
func (s *testSuite) TestMultiUpdate(c *C) {
	...
	tk := testkit.NewTestKit(c, s.store)
	tk.MustExec("use test")
	// fix https://yougam/libraries/pingcap/tidb/issues/369
	testSQL := `
	...
	// fix https://yougam/libraries/pingcap/tidb/issues/376
