...
import (
	...
	"github.com/insionng/yougam/libraries/Unknwon/com"
)
...
func ExampleGetSrcPath() {
	srcPath, err := com.GetSrcPath("github.com/insionng/yougam/libraries/Unknwon/com")
	if err != nil {
		fmt.Println(err)
		return
	}
...
func ExampleExpand() {
	...
	// Output: http://gowalker.org/yougam/libraries/Unknwon/gowalker
}
